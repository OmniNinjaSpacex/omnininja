...
| Arquivos finalizados | Ativo | Arquivos citados pelo executor selecionado são registrados por tarefa e oferecidos como downloads autenticados. Code Interpreter e Shell permanecem mutuamente exclusivos dentro de uma mesma requisição. | [Code Interpreter](https://developers.openai.com/api/docs/guides/tools-code-interpreter), [Shell](https://developers.openai.com/api/docs/guides/tools-shell) |
...
| Code Interpreter | Ativo em Chat | Análise de dados e criação de arquivos em container automático. Não é enviado junto com Shell na mesma requisição. | [Code Interpreter](https://developers.openai.com/api/docs/guides/tools-code-interpreter) |
| Hosted Shell | Ativo em Work/Codex | Comandos, análise, arquivos e builds em container efêmero da OpenAI; nunca no servidor principal e nunca junto com Code Interpreter na mesma requisição. | [Shell](https://developers.openai.com/api/docs/guides/tools-shell) |
